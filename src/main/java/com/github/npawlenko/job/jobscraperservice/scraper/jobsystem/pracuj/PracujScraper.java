package com.github.npawlenko.job.jobscraperservice.scraper.jobsystem.pracuj;
...
//@Scraper
@Getter
public class PracujScraper extends AbstractUnauthenticatedJobSystemScraper {
    private final JobSystem jobSystem = JobSystem.Pracuj;

    public PracujScraper(WebDriverProperties webDriverProperties) {
