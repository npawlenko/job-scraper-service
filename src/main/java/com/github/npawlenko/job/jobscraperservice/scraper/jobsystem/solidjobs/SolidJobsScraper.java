package com.github.npawlenko.job.jobscraperservice.scraper.jobsystem.solidjobs;
...
//@Scraper
@Getter
public class SolidJobsScraper extends AbstractUnauthenticatedJobSystemScraper {
    private final JobSystem jobSystem = JobSystem.SolidJobs;

    public SolidJobsScraper(WebDriverProperties webDriverProperties) {
